...
function bodyOnLoad()
{
	with (window.frmMilestone)
	{
		...
		if (hidProjectedStartDt.value == "")
		{
		    txtActualStartDt.disabled = true;
		    txtActualEndDt.disabled = true;
	...
	<table id="tabUpdate" width="100%" bgcolor="cornsilk" border="1" cellspacing="0" cellpadding="2" bordercolor="tan">
	    ...
	    <tr>
			...
			<td>
				...
				<input type="text" id="txtProjectedStartDt" name="txtProjectedStartDt" value="<%=strPlannedStart%>" class="dateselection"/>
				<!--<a id="hrefProjectStartDtPicker" href="javascript: cmdDate_onclick('txtProjectedStartDt')"><img id="imgProjectStartDtPicker" src="../mobilese/today/images/calendar.gif" alt="Choose Date" border="0" WIDTH="26" HEIGHT="21" /></a>--></td>
			<td>
				<span id="targetend">
				<input type="hidden" id="hidProjectedEndDt" name="hidProjectedEndDt" value="<%=strPlannedEnd%>" />
				<input type="text" id="txtProjectedEndDt" name="txtProjectedEndDt" value="<%=strPlannedEnd%>" class="dateselection"/>
				<!--<a id="hrefProjectedEndDtPicker" href="javascript: cmdDate_onclick('txtProjectedEndDt')"><img id="imgProjectedEndDtPicker" src="../mobilese/today/images/calendar.gif" alt="Choose Date" border="0" WIDTH="26" HEIGHT="21" /></a>--></span></td></tr>
	    <tr>
			...
			<td>
				...
				<input type="text" id="txtActualStartDt" name="txtActualStartDt" value="<%=strActualStart%>" class="dateselection"/>
				<!--<a id="hrefActualStartDtPicker" href="javascript: cmdDate_onclick('txtActualStartDt')"><img id="imgActualStartDtPicker" src="../mobilese/today/images/calendar.gif" alt="Choose Date" border="0" WIDTH="26" HEIGHT="21" /></a>--></td>
			<td>
				<span id="actualend">
				<input type="hidden" id="hidActualEndDt" name="hidActualEndDt" value="<%=strActualEnd%>" /> 
				<input type="text" id="txtActualEndDt" name="txtActualEndDt" value="<%=strActualEnd%>" class="dateselection"/> 
				<!--<a id="hrefActualEndDtPicker"href="javascript: cmdDate_onclick('txtActualEndDt')"><img id="imgActualEndDtPicker" src="../mobilese/today/images/calendar.gif" alt="Choose Date" border="0" WIDTH="26" HEIGHT="21" /></a>--></span></td></tr>
	    <tr>
