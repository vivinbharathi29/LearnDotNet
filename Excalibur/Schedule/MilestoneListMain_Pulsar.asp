...
{
    modalDialog.open({ dialogTitle: 'Add Custom Item', dialogURL: 'Schedule_Pulsar.asp?ProdVID=' + PVID + '&ScheduleID=' + ScheduleID + '', dialogHeight: 550, dialogWidth: 600, dialogResizable: true, dialogDraggable: true });
	/*var strID;
	strID = window.showModalDialog("Schedule_Pulsar.asp?ProdVID=" + PVID + "&ScheduleID=" + ScheduleID, "", "dialogWidth:545px;dialogHeight:475px;maximize:Yes;edge: Sunken;center:Yes; help: No;resizable: Yes;status: Yes")
