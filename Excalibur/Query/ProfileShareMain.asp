...
function cmdAddGroup_onclick(){
	var strResult;
	strResult = window.showModalDialog("ProfileShareProperties.asp?AddType=2&ProfileID=" + txtProfileID.value + "&EmployeeID=0&CanEdit=&CanDelete=","","dialogWidth:520px;dialogHeight:220px;edge: Raised;center:Yes; help: No;resizable: No;status: No"); 
	if (typeof(strResult) != "undefined")
		window.location.href =  "ProfileShare.asp?ID=" + txtProfileID.value;
}
