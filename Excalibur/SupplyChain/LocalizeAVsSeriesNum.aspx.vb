Partial Class SupSCM_LocalizeAVsSeriesNum
        ...
        Try
            Select Case ddlAvType.SelectedItem.Value
                ...
                Case 1, 2, 3, 4 '1=Images, 2=HWKits, 3=Keyboards, 4=OS Restore Media
                    Dim strPath As String = Me.ResolveUrl("~/SupplyChain/LocalizeAVs.asp")
                    strPath = """" & strPath & "?Mode=add&PVID=" & PVID & "&strSeriesSummary=" & ddlSeriesNumbers.SelectedItem.Text & "&BID=" & BID & "&AvType=" & ddlAvType.SelectedItem.Value & "&UserName=" & UserName & "&pulsarplusDivId=SupplyChain" & """, """", ""dialogWidth:875px;dialogHeight:700px;edge: Sunken;center:Yes; help: No;resizable: Yes;status: No"""
