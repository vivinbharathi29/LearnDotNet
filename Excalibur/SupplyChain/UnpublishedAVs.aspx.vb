...
Partial Class SupUnpublishedAVs
        ...
        Try
            If Not Me.Page.IsPostBack Then
                ...
                If dtAVs.Rows.Count = 0 Then
                    lblHeader.Text = "There are no Hidden AVs to Report"
                Else
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        Try
            ...
            Else
                Response.Write("<script language='javascript'> { if(window.parent.frames['UpperWindow']){parent.window.parent.modalDialog.cancel(true);} else {window.parent.close();} }</script>")
            End If
        Catch ex As Exception
            Response.Write(ex.ToString)
        End Try
