...
'
    ...
    bKETeamNotification = rs("KETeamNotification")
...
'
    ...
    'Hide ShowPM field on UI and always checked - task 22848
	'bShowOnPm = (Request.Form("cbShowOnPm") = "on")
	bShowPhWebActionItems = (Request.Form("cbShowPhWebActionItems") = "on")
    bKETeamNotification = (Request.Form("cbKETeamNotification") = "on")
    ...
    Dim sKETeamNotification 
    If bKETeamNotification Then
        sKETeamNotification = 1
    else 
        sKETeamNotification = 0
    end if

	cn.BeginTrans()

	Set cmd = dw.CreateCommandSP(cn, "usp_UpdateKmat_Pulsar")
	...
	dw.CreateParameter cmd, "@p_ShowOnPm", adBoolean, adParaminput, 1, 1
	dw.CreateParameter cmd, "@p_ShowPhWebActionItems", adBoolean, adParaminput, 1, 1
    ...
    dw.CreateParameter cmd, "@p_KETeamNotification", adBoolean, adParaminput, 1, sKETeamNotification
...
<body onload="Body_OnLoad('<%=Request("pulsarplusDivId")%>')">
    <form method="post" id="frmMain">
        ...
        <table class="FormTable" style="background-color: cornsilk; width: 100%; border-width: 1px; border-spacing: 0px; padding: 1px; border-color: tan;">
            <tr>
                <th>KMAT</th>
                <td>
                    <div id="kmat" style="display: none">
                        <input type="text" id="txtKmat" name="txtKmat" maxlength="10" value="<%= sKmat%>" /></div>
                    <div id="kmatText">
                        <table width="100%" border="0">
                            <tr>
                                <td style="border: none"><%= PrepForWeb(sKmat)%></td>
                                <td style="border: none; text-align: right"><a href="javascript:EditKmat();">Edit</a></td>
                            </tr>
                        </table>
                    </div>
                </td>
            ...
            <tr>
                <th>EZCKMAT</th>
                <td>
                    <div id="ezcKmat" style="display: none">
                        <input type="text" id="txtEzcKmat" name="txtEzcKmat" maxlength="10" value="<%= sEzcKmat%>" /></div>
                    <div id="ezcKmatText">
                        <table width="100%" border="0">
                            <tr>
                                <td style="border: none"><%= PrepForWeb(sEzcKmat)%></td>
                                <td style="border: none; text-align: right"><a href="javascript:EditEzcKmat();">Edit</a></td>
                            </tr>
                        </table>
                    </div>
                </td>
            ...
            <tr>
                <th>Project Code</th>
                <td>
                    <div id="projectCd" style="display: none">
                        <input type="text" id="txtProjectCd" name="txtProjectCd" value="<%= sProjectCd%>" style="width: 300px" maxlength="15" /></div>
                    <div id="projectCdText">
                        <table width="100%" border="0">
                            <tr>
                                <td style="border: none"><%= PrepForWeb(sProjectCd)%></td>
                                <td style="border: none; text-align: right"><a href="javascript:EditProjectCd();">Edit</a></td>
                            </tr>
                        </table>
                    </div>
                </td>
            ...
            <tr>
                <th>Plant Code</th>
                <td>
                    <div id="plantCd" style="display: none">
                        <input type="text" id="txtPlantCd" name="txtPlantCd" value="<%= sPlantCd%>" style="width: 300px" /></div>
                    <div id="plantCdText">
                        <table width="100%" border="0">
                            <tr>
                                <td style="border: none"><%= PrepForWeb(sPlantCd)%></td>
                                <td style="border: none; text-align: right"><a href="javascript:EditPlantCd();">Edit</a></td>
                            </tr>
                        </table>
                    </div>
                </td>
            ...
            <tr>
                <th>Config Code</th>
                <td>
                    <div id="configCd" style="display: none">
                        <input type="text" id="txtConfigCd" name="txtConfigCd" value="<%= sConfigCd%>" style="width: 300px" /></div>
                    <div id="configCdText">
                        <table width="100%" border="0">
                            <tr>
                                <td style="border: none"><%= PrepForWeb(sConfigCd)%></td>
                                <td style="border: none; text-align: right"><a href="javascript:EditConfigCd();">Edit</a></td>
                            </tr>
                        </table>
                    </div>
                </td>
            ...
            <tr>
                <th>Sales Org</th>
                <td>
                    <div id="salesOrg" style="display: none">
                        <input type="text" id="txtSalesOrg" name="txtSalesOrg" value="<%= sSalesOrg%>" style="width: 300px" /></div>
                    <div id="salesOrgText">
                        <table width="100%" border="0">
                            <tr>
                                <td style="border: none"><%= PrepForWeb(sSalesOrg)%></td>
                                <td style="border: none; text-align: right"><a href="javascript:EditSalesOrg();">Edit</a></td>
                            </tr>
                        </table>
                    </div>
                </td>
            ...
            <tr style="display: none">
                ...
                <td align="left">
                    <input type="checkbox" id="cbShowPhWebActionItems" name="cbShowPhWebActionItems" checked /></td>
            </tr>
            <tr>
                <th>AV Series Name</th>
                <td>
                    <div id="divAVSeriesName" style="display: none">
                        <input type="text" id="txtAvSeriesName" name="txtAvSeriesName" value="<%= sAVSeriesName%>" /></div>
                    <div id="divAVSeriesNameText">
                        <table width="100%" border="0">
                            <tr>
                                <td style="border: none"><%= PrepForWeb(sAVSeriesName)%></td>
                                <td style="border: none; text-align: right"><a href="javascript:EditAVSeriesName();">Edit</a></td>
                            </tr>
                        </table>
                    </div>
                </td>
            ...
            <tr>
                <th>KE Team Notification</th>
                <td align="left">
                    <input type="checkbox" id="cbKETeamNotification" name="cbKETeamNotification" <% If bKETeamNotification Then %>Checked<% End If %> /></td>
            </tr>
        </table>
    </form>
</body>
