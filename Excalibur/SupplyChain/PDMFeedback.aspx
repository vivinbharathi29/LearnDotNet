<%@ Page Language="VB" AutoEventWireup="false" Inherits="DummyVBApp.SupPDMFeedback"
...
<body runat="server" id="thisBody">
    ...
    <asp:Label ID="lblAvNoText" runat="server" Style="position: absolute; left: 120px;
    ...
    <asp:GridView ID="gvAvActionItems" Width="1068px" runat="server" GridLines="vertical" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Feedback" HeaderStyle-Wrap="true" ItemStyle-Wrap="true" SortExpression="PDMFeedback">
                <ItemTemplate>
