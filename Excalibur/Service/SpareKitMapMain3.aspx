<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="DummyVBApp.Service_SpareKitMapMain3" Codebehind="SpareKitMapMain3.aspx.vb" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlMain" runat="server">
                ...
                <div style="width: 650px">
                    <asp:DataGrid ID="mapGrid" runat="server" ShowFooter="true" AutoGenerateColumns="false"
                        CssClass="Table" Width="650px">
                        <Columns>
                            <asp:TemplateColumn HeaderText="AV Category">
                                <FooterTemplate>
                                    <asp:DropDownList ID="add_ddlAvCategory" runat="server" />
                                </FooterTemplate>
                                <ItemTemplate>
                    ...
                    <p style="text-align: right">
                        <asp:Button ID="btnSave" runat="server" Text="Submit" OnClientClick="bPostBack=true;" />
                        &nbsp;&nbsp;
