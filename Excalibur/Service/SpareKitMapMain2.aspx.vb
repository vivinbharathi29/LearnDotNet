...
Partial Class Service_SpareKitMapMain2
...
#Region " Page Properties "
    ...
    Public ReadOnly Property ServiceFamilypn() As String
        Get
            Return Request.QueryString("ServiceFamilypn")
        End Get
    End Property

    Public ReadOnly Property Division() As String
        Get
            If Request.QueryString("Divison") Is Nothing Then
                Return DIVISION_NOTEBOOKS
            Else 'Desktop pages send the Division parameter like 2
                Return Request.QueryString("Division")
            End If
        End Get
    End Property
...
#End Region
    ...
    Const DIVISION_NOTEBOOKS As String = "1"
    Const DIVISION_DESKTOPS As String = "2"
...
#Region " Page Events "
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If SpareKitMapId = "0" Or SpareKitMapId = String.Empty Then
                'Get New SpareKitMapId
                If Division = DIVISION_NOTEBOOKS Then
                    SpareKitMapId = dw.GetNewSpareKitMapId(ProductBrandId, SpareKitId)
                Else
                    SpareKitMapId = HPQ.Excalibur.Service.GetDesktopsNewSpareKitMapId(ProductBrandId, SpareKitId, ServiceFamilypn)
                End If
            Else
                EditMode = True
            End If
...
#Region " Button Events "
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim secObj As HPQ.Excalibur.Security = New HPQ.Excalibur.Security(HttpContext.Current.User.Identity.Name.ToString())
        If Not (secObj.IsSysAdmin Or _
                secObj.UserInRole(HPQ.Excalibur.Security.ProgramRoles.GPLM) Or _
        ...
        Dim dgFooter As DataGridItem = _
        ...
        'carmen Comment this code window.opener.location.reload(true);
        System.Web.UI.ScriptManager.RegisterClientScriptBlock(Me.btnSave, Me.GetType(), "Close_Window", "parent.window.parent.modalDialog.cancel(true);", True)
    ...
    Private Function checkDuplicates(ByVal SpareKitMapId As String, catid As String, avno As String, ByVal pbId As String) As Boolean
        'Dim sql As String
