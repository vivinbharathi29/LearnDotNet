...
'		rs.Open "spGetProductVersionByName '" & request("Product") & "'",cn,adOpenForwardOnly
	...
	if strFilterList <> "" then
		...
		if request("FileType") = "" then
			strCountNote = strCountNote & "<a href=""Localization2.asp?ProdID=" & DisplayedID & """>Show All</a>"
		end if
...
'	end if
	...
	if blnFound then
					...
					strImagesDisplayed=strImagesDisplayed & "," & rs("ImageID")
						...
						if isnumeric(rs("Priority")) then
							...
							elseif request("FileType") = "" then
								OutArray(i) = "<a target=""_blank"" href=""DeliverableMatrix.asp?ID=" & rs("ImageID") & "&PINTest=" & request("PINTest") & """>" & rs("Dash") & "</a> (Tier&nbsp;" & trim(rs("Priority") & "")& ")"  
							else
								OutArray(i) = rs("Dash") & " (Tier&nbsp;" & trim(rs("Priority")) & ")"
							end if
							intNativeCount = intNativeCount + 1
						else
							set rs2 = server.CreateObject("ADODB.recordset")
							rs2.Open "spGetImageProperties4Sub "  & rs("ImageDefID") & ",'" & replace(rs("Priority")," " ,"")  & "'" ,cn,adOpenForwardOnly
		...
		'	if strRegionDef = "" then
				strRegionDef = "<TD><font face=verdana size=1>" & rs("Name") & "&nbsp;</font></td><TD><font face=verdana size=1>" & rs("OptionConfig") & "&nbsp;</font></td><TD><font face=verdana size=1>" & rs("CountryCode") & "</font></td>"
				...
				if trim(strTemp) = "" then
					...
					if intNativeCount > 0 then
						strRegionDef = strRegionDef & "<TD><font face=verdana size=1>" & replace(rs("Dash")," ","") & strTemp & "</font></td>"
					else
...
<%
	...
	strModelRow = strModelRow & "<td bgcolor=gainsboro><font size=1 face=verdana><b>Model </b></font></td><td bgcolor=white rowspan=9 colspan=9><font size=1 face=verdana><b>Total Dash Images:&nbsp;<label ID=lblImageCount>" & TotalImageCount & "</label></b></font>" & strCountNote & strShowOption & "</td></tr>"
...
%>
		...
		<%
			...
			Response.Write strTierHeader & "<TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Localization</b></font></TD><TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>HP<BR>Code</b></font></TD><TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Country<BR>Code</b></font></TD><TD width=80 style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Image Dash</b></font></TD><TD width=80 style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Product Dash</b></font></TD><TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Languages</b></font></TD><TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Keyboard</b></font></TD><TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>KWL</b></font></TD><TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Power<BR>Cords</b></font></TD><TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Restore<BR>Solution</b></font></TD></TR>"
			
		%>
		<%=strRegions%>
		<%=strTotalRows & "<TD colspan=10 style=""BORDER-TOP: black solid""><font face=verdana size=1>Tier x</font></td></tr>"%>
		<%
			if Tier0Found then
				Response.Write "<TR>"
				...
				next
				Response.Write "<TD colspan=10><font face=verdana size=1>Tier 0</font></td></tr>"
			end if
			if Tier1Found then
				Response.Write "<TR>"
				...
				next
				Response.Write "<TD colspan=10><font face=verdana size=1>Tier 1</font></td></tr>"
			end if
			...
			if Tier2Found then
				...
				next
				Response.Write "<TD colspan=10><font face=verdana size=1>Tier 2</font></td></tr>"
			end if
			...
			if Tier3Found then
				...
				next
				Response.Write "<TD colspan=10><font face=verdana size=1>Tier 3</font></td></tr>"
			end if
			...
			if Tier4Found then
				...
				next
				Response.Write "<TD colspan=10><font face=verdana size=1>Tier 4</font></td></tr>"
			end if
			...
			if Tier5Found then
				...
				next
				Response.Write "<TD colspan=10><font face=verdana size=1>Tier 5</font></td></tr>"
			end if
			...
			if Tier6Found then
				...
				next
				Response.Write "<TD colspan=10><font face=verdana size=1>Tier 6</font></td></tr>"
			end if
			...
			if Tier7Found then
				...
				next
				Response.Write "<TD colspan=10><font face=verdana size=1>Tier 7</font></td></tr>"
			end if
			...
			if Tier8Found then
				...
				next
				Response.Write "<TD colspan=10><font face=verdana size=1>Tier 8</font></td></tr>"
			end if
			...
			if Tier9Found then
				...
				next
				Response.Write "<TD colspan=10><font face=verdana size=1>Tier 9</font></td></tr>"
			end if
			...
			if Tier10Found then
				...
				next
				Response.Write "<TD colspan=10><font face=verdana size=1>Tier 10</font></td></tr>"
			end if
		%>
	</TABLE>
