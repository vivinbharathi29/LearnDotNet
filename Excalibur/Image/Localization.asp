...
'		rs.Open "spGetProductVersionByName '" & request("Product") & "'",cn,adOpenForwardOnly
	...
	'Redirect to Commercial Page if needed
	if trim(strDevCenter) <> "2" then
		Response.Redirect "localization2.asp?" & Request.QueryString
	end if
					...
					strImagesDisplayed=strImagesDisplayed & "," & rs("ImageID")
						...
						if isnumeric(rs("Priority")) then
							...
							elseif request("FileType") = "" then
								OutArray(i) = "<a target=""_blank"" href=""DeliverableMatrix.asp?ID=" & rs("ImageID") & "&PINTest=" & request("PINTest") & """>" & rs("Priority") & "</a>"
							else
...
<%
	...
	strModelRow = strModelRow & "<td bgcolor=gainsboro><font size=1 face=verdana><b>Model </b></font></td><td bgcolor=white rowspan=9 colspan=7><font size=1 face=verdana><b>Total Dash Images:&nbsp;<label ID=lblImageCount>" & TotalImageCount & "</label></b></font>" & strCountNote & strShowOption & "</td></tr>"
...
%>
		...
		<%
			...
			Response.Write strTierHeader & "<TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Localization</b></font></TD><TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>HP<BR>Code</b></font></TD><TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Dash<BR>Code</b></font></TD><TD width=80 style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Images</b></font></TD><TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Country<BR>Code</b></font></TD><TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Keyboard</b></font></TD><TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>KWL</b></font></TD><TD style=""BORDER-TOP: black solid""><font size=1 face=verdana><b>Power<BR>Cords</b></font></TD></TR>"
		...
		<%
			if Tier0Found then
				...
				next
				Response.Write "<TD colspan=8><font face=verdana size=1>Tier 0</font></td></tr>"
			end if
			...
			if Tier6Found then
				...
				next
				Response.Write "<TD colspan=8><font face=verdana size=1>Tier 6</font></td></tr>"
			end if
			...
			if Tier7Found then
				...
				next
				Response.Write "<TD colspan=8><font face=verdana size=1>Tier 7</font></td></tr>"
			end if
			...
			if Tier8Found then
				...
				next
				Response.Write "<TD colspan=8><font face=verdana size=1>Tier 8</font></td></tr>"
			end if
			...
			if Tier9Found then
				...
				next
				Response.Write "<TD colspan=8><font face=verdana size=1>Tier 9</font></td></tr>"
			end if
			...
			if Tier10Found then
				...
				next
				Response.Write "<TD colspan=8><font face=verdana size=1>Tier 10</font></td></tr>"
			end if
		%>
	</TABLE>
