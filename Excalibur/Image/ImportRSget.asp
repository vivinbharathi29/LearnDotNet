...
'	rs.open "spListImageDefinitionsByProduct " & ID ,cn,adOpenForwardOnly
	if rs.EOF and rs.BOF then 	
		...
		strResult =  "<Table ID=""ImageTable"" width=100% border=0 cellpadding=1 cellspacing=0><TR bgcolor=cornsilk><TD><INPUT style=""width:16;height:16;"" type=""checkbox"" checked id=chkALL name=chkAll LANGUAGE=javascript onclick=""return chkAll_onclick()""></TD><TD><font size=1 face=verdana><b>SKU&nbsp;Number</b></font></TD><TD><font size=1 face=verdana><b>Brand&nbsp;&nbsp;</b></font></TD><TD><font size=1 face=verdana><b>OS&nbsp;&nbsp;</b></font></TD><TD><font size=1 face=verdana><b>Software&nbsp;&nbsp;</b></font></TD><TD><font size=1 face=verdana><b>Type&nbsp;&nbsp;</b></font></TD></tr>"
		do while not rs.EOF 
				...
				strResult = strResult & "<TD nowrap style=""BORDER-TOP: gray thin solid""><font size=1 face=verdana>" & rs("SKUNumber") & "&nbsp;</font></TD>"
				...
				strResult = strResult & "<TD style=""BORDER-TOP: gray thin solid""><font size=1 face=verdana>" & rs("SWType") & "&nbsp;</font></TD>"
				strResult = strResult & "<TD style=""BORDER-TOP: gray thin solid""><font size=1 face=verdana>" & rs("ImageType") & "&nbsp;</font></TD>"
			rs.MoveNext
		loop
		rs.Close
