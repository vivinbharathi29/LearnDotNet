...
<%
    ...
    for each strID in IDArray
	    ...
	    if request("txtEngCoordinator") = "1" and request("txtSvcCoordinator") = "1" then
	        cm.CommandText = "spUpdateSubassemblyNumber"	
        elseif request("txtEngCoordinator") = "1" then
	        cm.CommandText = "spUpdateSubassemblyNumberEngineering"	
        elseif request("txtSvcCoordinator") = "1" then
