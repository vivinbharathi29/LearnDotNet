<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="DummyVBApp.UnpublishedAVs" EnableEventValidation="false" Codebehind="UnpublishedAVs.aspx.vb" %>
...
<head id="Head1" runat="server">
    <title>Unpublished AVs</title>
    <link href="../../../style/general.css" rel="stylesheet" type="text/css" />
</head>
<body runat="server" id="thisBody">
    <form id="myform" runat="server">
    <asp:Label ID="lblHeader" runat="server" Text="Please Select AVs To Activate (SCM / Program Matrix)"
    ...
    <asp:GridView ID="gvUnpublishedAVs" runat="server" GridLines="vertical" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="GPGDescription" HeaderText="GPGDescription" HeaderStyle-HorizontalAlign="Center">
            </asp:BoundField>
            <asp:BoundField DataField="CPLBlindDt" HeaderText="CPL Blind Date" HeaderStyle-HorizontalAlign="Center"
                DataFormatString="{0:MM/dd/yyyy}" HtmlEncode="false"></asp:BoundField>
            <asp:BoundField DataField="RASDiscontinueDt" HeaderText="End of Manufacturing" HeaderStyle-HorizontalAlign="Center"
                DataFormatString="{0:MM/dd/yyyy}" HtmlEncode="false"></asp:BoundField>
