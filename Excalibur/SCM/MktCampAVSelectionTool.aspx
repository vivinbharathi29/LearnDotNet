<%@ Page Language="VB" AutoEventWireup="false" Inherits="DummyVBApp.MktCampAVSelectionTool" Codebehind="MktCampAVSelectionTool.aspx.vb" %>
...
<head id="Head1" runat="server">
    <title>Marketing Campaign AV Selection Tool</title>
        ...
        <div style="border: thin solid rgb(128,128,128); background-color: rgb(220,220,220);width: 100%;">
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td style="width: 80%">
                        <asp:Label ID="CurrPlats" runat="server" Text="Clash 1.0 > hp w"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="width: 20%; text-align: right; font-weight: bold; color: #000090;">
                        Current Mkt Campaign:&nbsp;
                    </td>
                    <td style="width: 80%">
                        <asp:Label ID="lblMktCampaign" runat="server" Text="Back to School"></asp:Label>
                    &nbsp;- <span  style="width: 20%; text-align: right; font-weight: bold; color: #000090;">From:</span>
                        <asp:Label ID="lblStartDate" runat="server" Text="Start Date"></asp:Label>
&nbsp;<span  style="width: 20%; text-align: right; font-weight: bold; color: #000090;">To:</span>
             ...
             <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true"><ContentTemplate>
              <asp:GridView ID="gvRegAVSelToolGrid" runat="server" BorderStyle="Solid" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Mkt Camp AV Detail Product Brand ID" Visible="False">
                        <ItemTemplate>
                            <asp:Label ID="lblMktCampaigns_AVDetailProductBrandID" runat="server" Text='<%# Bind("MktCampaigns_AVDetailProductBrandID") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Mkt Camp AV Detail ID" Visible="False">
                        <ItemTemplate>
                            <asp:Label ID="lblMktCampaignsID" runat="server" Text='<%# Bind("MktCampaignsID") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Plant Start Date">
                         <ItemTemplate>
                                <asp:Label ID="lblRegCPLBlind" Width="75px" runat="server" Text='<%# Bind("PlantStartDate") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle HorizontalAlign="Center" CssClass="BottomBorder"></HeaderStyle>
                         <ItemStyle HorizontalAlign="Center" Width="75px" />
                    </asp:TemplateField>
                    
                    <asp:TemplateField HeaderText="Plant End Date">
                         <ItemTemplate>
                                <asp:Label ID="lblRegRASDics" Width="75px" runat="server" Text='<%# Bind("PlantEndDate") %>'></asp:Label>
                         </ItemTemplate>
                         <HeaderStyle HorizontalAlign="Center" CssClass="BottomBorder"></HeaderStyle>
                         <ItemStyle HorizontalAlign="Center" Width="75px" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Plant Selected" ControlStyle-Width="0px" Visible="true" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                                <asp:Label ID="chkPlantCheckedRec" runat="server" Text='<%# Bind("PlantCheckedRecFlag") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Center" BackColor="Ivory" CssClass="BottomBorder" />
                        <ItemStyle HorizontalAlign="Center" Width="0px" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Plant Active" ControlStyle-Width="0px" Visible="true" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                                <asp:Label ID="chkPlantRecSelected" runat="server" Text='<%# Bind("PlantRecSelectedFlag") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Center" BackColor="Ivory" CssClass="BottomBorder" />
                        <ItemStyle HorizontalAlign="Center" Width="0px" />
                    </asp:TemplateField>
                    
                    <asp:TemplateField HeaderText="Mkt Selected" ControlStyle-Width="0px" Visible="true" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Mkt Active" ControlStyle-Width="0px" Visible="true" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
