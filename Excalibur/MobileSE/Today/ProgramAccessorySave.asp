...
<%
	...
	cm.CommandText = "spUpdateProductVersionAccessory"
	...
	if cn.Errors.Count > 1 then
		...
		Response.Write "<INPUT style=""Display:none"" type=""text"" id=txtSuccess name=txtSuccess value=""" & clng(request("cboPM")) & """>"
		cn.CommitTrans
	end if
