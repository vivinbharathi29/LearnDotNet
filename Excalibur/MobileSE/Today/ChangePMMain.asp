...
%>
<form ID=frmEmployee action="ChangePMSave.asp" method=post>
...
<TR>
	...
	strImpersonateID=request("PMImpersonateID")
	strEmployeeID=request("EmployeeID")
'	rs.Close
'	if request("PMTypeID")= "2" then
'		rs.Open "spGetPINPMList4MyDevCenter " & clng(strEmployeeID),cn,adOpenForwardOnly
'	else	
'		rs.Open "spGetSEPMList4MyDevCenter " & clng(strEmployeeID),cn,adOpenForwardOnly
'	end if
