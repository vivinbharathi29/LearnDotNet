    ...
    <script type="text/javascript">
        ...
        function goSearch_onclick() {
            ...
            if (txtSearch.value != "") {
                ...
                //window.location.href = "Today/Find_Pulsar.asp?Find=" + escape(txtSearch.value) + "&Type=Part";
                window.open("Today/Find_Pulsar.asp?Find=" + escape(txtSearch.value) + "&Type=Part", "", "width=" + GetWindowSize('width') + ",height=600,toolbar=0,resizable=1,scrollbars=1");
